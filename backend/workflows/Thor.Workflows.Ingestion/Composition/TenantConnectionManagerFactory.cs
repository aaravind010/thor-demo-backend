...
/// Both the Master and tenant legs authenticate with an RDS IAM token minted for
/// <c>THOR_MASTERDB_USER</c> in <c>THOR_MASTERDB_REGION</c>; there is no password auth path.
/// </summary>
