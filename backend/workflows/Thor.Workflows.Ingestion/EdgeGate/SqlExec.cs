...
internal static class SqlExec
{
    ...
    public static async Task ExecAsync(TenantDbContext db, string sql, params NpgsqlParameter[] parameters)
    {
    ...
    public static async Task<long> ScalarLongAsync(TenantDbContext db, string sql, params NpgsqlParameter[] parameters)
    {
        await db.Database.OpenConnectionAsync();
        try
        {
