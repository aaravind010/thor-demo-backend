...
{
    public async Task StageAsync(IngestBatch batch, Guid tenantId, Guid scanManifestId, int batchSeq)
    {
        ...
        if (batch.Accounts.Count > 0)
        {
            ...
            await stagingAccounts.BulkInsertAsync(accountRows);
        ...
        if (batch.Groups.Count > 0)
        {
            ...
            await stagingGrps.BulkInsertAsync(groupRows);
        ...
        if (batch.Assets.Count > 0)
        {
            ...
            await stagingAssets.BulkInsertAsync(assetRows);
        ...
        if (batch.Entitlements.Count > 0)
        {
            ...
            await stagingEntitlements.BulkInsertAsync(entitlementRows);
